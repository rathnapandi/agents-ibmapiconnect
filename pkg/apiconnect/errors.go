...
var (
	ErrCommunicatingWithGateway = errors.New(3005, "could not make request to IBM API Connect")
	ErrMarshallingBody          = errors.New(3006, "could not create the body of the request to IBM API Connect")
